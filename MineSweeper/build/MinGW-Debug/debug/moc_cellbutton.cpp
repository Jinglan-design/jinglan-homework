...
static constexpr auto qt_meta_stringdata_CLASSCellButtonENDCLASS = QtMocHelpers::stringData(
    "CellButton",
    "leftClicked",
    "",
    "x",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSCellButtonENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSCellButtonENDCLASS_t qt_meta_stringdata_CLASSCellButtonENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "CellButton"
        QT_MOC_LITERAL(11, 11),  // "leftClicked"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 1),  // "x"
        QT_MOC_LITERAL(26, 1),  // "y"
        QT_MOC_LITERAL(28, 12)   // "rightClicked"
    },
    "CellButton",
    "leftClicked",
    "",
...
void CellButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &CellButton::leftClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CellButton::*)(int , int );
            if (_t _q_method = &CellButton::rightClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
